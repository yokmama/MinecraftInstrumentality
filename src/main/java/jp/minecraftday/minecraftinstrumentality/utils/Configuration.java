...
/***
 *
 * original EssentialsConf
 */
public class Configuration extends YamlConfiguration {
    protected static final Logger LOGGER = Logger.getLogger("MinecraftDay");
    ...
    @Override
    public synchronized org.bukkit.util.Vector getVector(String path, Vector def) {
