...
public class TextRawGenerator {
    List<TextRawGenerator.Message> texts = new ArrayList<>();
    ...
    public TextRawGenerator append(String text, boolean italic, ClickEvent clickEvent){
        texts.add(new Message(text, italic, clickEvent));
        return this;
    }
    public TextRawGenerator append(String text, boolean italic, String hoverText){
        texts.add(new Message(text, italic, hoverText));
        return this;
    }
    public TextRawGenerator append(String text, boolean italic){
        return append(text, italic, (String)null);
    }
    public TextRawGenerator append(String text){
